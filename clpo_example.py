...
# Import the new pure Python JANPA interface functions
from janpa.orbital_transformation import generate_CLPO_molecule_edges, generate_HAO_molecule

basis = 'sto-3g'
geo = 'N 0. 0. 0. \n N 0. 0. 1.098'
nmol = sn.Molecule(geometry=geo, basis_set=basis, backend='pyscf', units='a')

# Replaced sn.CLPO.generate_CLPO_molecule_edges with the pure Python version
